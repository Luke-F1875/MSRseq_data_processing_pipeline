...
#SBATCH -o ./3_bowtie2/$index_file/$sample_dir$underscore$sample.err
#SBATCH -e ./3_bowtie2/$index_file/$sample_dir$underscore$sample.err
#SBATCH --nodes=1
...
./tools/bowtie2-2.3.3.1-linux-x86_64/bowtie2 -x $reference -U $bar_directory$sample$in1   -S ./3_bowtie2/$index_file/$sample_dir$unde$
sleep 0.1
python ./tools/sam_bin_split.py -i ./3_bowtie2/$index_file/$sample_dir$underscore$sample$suffix -o ./3_bowtie2/$index_file/  -breaks $
