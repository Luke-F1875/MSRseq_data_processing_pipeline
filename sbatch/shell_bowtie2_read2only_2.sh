...
reference=./ref_seq/bowtie2_index/hg38_chrtRNA_genesHighConfid_introRemoved_CCA/hg38_chrtRNA_genesHighConfid_introRemoved_CCA
mkdir -p 3_bowtie2
...
for fullpath in ./0_barcode*/SRR18302257_GSM5946941_HEK293T_polysomeRNA_AsO2_longRT_minusDM_rep2_Homo_sapiens/*bc11*_2.txt.gz
do
sleep 0.1
